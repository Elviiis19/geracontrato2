...
export const HomePage: React.FC<HomePageProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="flex flex-col items-center w-full">
      ...
      <section className="w-full bg-gradient-to-br from-slate-900 via-navy-900 to-slate-900 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32 text-center">
          ...
          <div className="mt-10 flex flex-col sm:flex-row justify-center gap-4">
            <button 
              ...
              aria-label="Ver modelos de contrato"
            >
            ...
            <button 
              ...
              className="px-8 py-4 bg-slate-800/80 hover:bg-slate-700 text-white text-lg font-medium rounded-xl border border-slate-700 backdrop-blur-sm transition-all flex items-center justify-center gap-2 hover:bg-slate-700"
      ...
      <section className="py-16 bg-white w-full border-b border-gray-100 shadow-sm relative z-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
            <div className="flex flex-col items-center">
              ...
              <h2 className="text-xl font-bold text-slate-900">Segurança Jurídica</h2>
            ...
            <div className="flex flex-col items-center">
              ...
              <h2 className="text-xl font-bold text-slate-900">Preenchimento Rápido</h2>
            ...
            <div className="flex flex-col items-center">
              <div className="w-14 h-14 bg-indigo-50 rounded-2xl flex items-center justify-center mb-6 text-indigo-600 shadow-sm">
              ...
              <h2 className="text-xl font-bold text-slate-900">Dados Protegidos</h2>
      ...
      <section id="modelos-contrato" className="w-full bg-slate-50 py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-blue-700 font-bold text-xs uppercase tracking-widest bg-blue-50 px-3 py-1 rounded-full">Modelos Disponíveis</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <button onClick={() => onNavigate('servico')} className="group bg-white rounded-2xl shadow-sm border border-slate-200 p-6 text-left hover:border-blue-500 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500">
              <div className="w-12 h-12 bg-blue-50 text-blue-600 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform border border-blue-100">
                 <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
              </div>
              <h3 className="font-bold text-lg text-slate-900 mb-2 group-hover:text-blue-700">Prestação de Serviços</h3>
            ...
            <button onClick={() => onNavigate('residencial')} className="group bg-white rounded-2xl shadow-sm border border-slate-200 p-6 text-left hover:border-emerald-500 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-emerald-500">
              <div className="w-12 h-12 bg-emerald-50 text-emerald-600 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform border border-emerald-100">
                <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" /></svg>
              </div>
              <h3 className="font-bold text-lg text-slate-900 mb-2 group-hover:text-emerald-700">Aluguel Residencial</h3>
            ...
            <button onClick={() => onNavigate('comercial')} className="group bg-white rounded-2xl shadow-sm border border-slate-200 p-6 text-left hover:border-purple-500 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-purple-500">
              <div className="w-12 h-12 bg-purple-50 text-purple-600 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform border border-purple-100">
                <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg>
              </div>
              <h3 className="font-bold text-lg text-slate-900 mb-2 group-hover:text-purple-700">Aluguel Comercial</h3>
             ...
             <button onClick={() => onNavigate('veiculo')} className="group bg-white rounded-2xl shadow-sm border border-slate-200 p-6 text-left hover:border-rose-500 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-rose-500">
              <div className="w-12 h-12 bg-rose-50 text-rose-600 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform border border-rose-100">
              ...
              <h3 className="font-bold text-lg text-slate-900 mb-2 group-hover:text-rose-700">Venda de Veículo</h3>
             ...
             <button onClick={() => onNavigate('arrendamentoRural')} className="group bg-white rounded-2xl shadow-sm border border-slate-200 p-6 text-left hover:border-amber-500 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-amber-500">
              <div className="w-12 h-12 bg-amber-50 text-amber-600 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform border border-amber-100">
                <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
              </div>
              <h3 className="font-bold text-lg text-slate-900 mb-2 group-hover:text-amber-700">Arrendamento Rural</h3>
             ...
             <button onClick={() => onNavigate('parceriaAgricola')} className="group bg-white rounded-2xl shadow-sm border border-slate-200 p-6 text-left hover:border-orange-500 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-orange-500">
              <div className="w-12 h-12 bg-orange-50 text-orange-600 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform border border-orange-100">
                <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" /></svg>
              </div>
              <h3 className="font-bold text-lg text-slate-900 mb-2 group-hover:text-orange-700">Parceria Agrícola</h3>
             ...
             <button onClick={() => onNavigate('uniaoEstavel')} className="group bg-white rounded-2xl shadow-sm border border-slate-200 p-6 text-left hover:border-pink-500 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-pink-500">
              <div className="w-12 h-12 bg-pink-50 text-pink-600 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform border border-pink-100">
                <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" /></svg>
              </div>
              <h3 className="font-bold text-lg text-slate-900 mb-2 group-hover:text-pink-700">União Estável</h3>
             ...
             <button onClick={() => onNavigate('namoro')} className="group bg-white rounded-2xl shadow-sm border border-slate-200 p-6 text-left hover:border-red-500 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-red-500">
              <div className="w-12 h-12 bg-red-50 text-red-600 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform border border-red-100">
              ...
              <h3 className="font-bold text-lg text-slate-900 mb-2 group-hover:text-red-700">Contrato de Namoro</h3>
      ...
      <section id="como-funciona" className="w-full bg-white py-20 border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <section className="w-full bg-slate-50 py-16 border-t border-slate-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold text-slate-900 mb-6">Por que usar um gerador de contratos online?</h2>
