    ...
    <footer className="bg-gray-800 text-gray-300 py-12 mt-auto print:hidden">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="border-t border-gray-700 pt-8 mt-8">
           <div className="bg-gray-900/50 p-4 rounded-lg mb-6 text-xs text-gray-400 text-justify leading-relaxed border border-gray-700">
             <strong className="text-gray-300">AVISO LEGAL:</strong> O Gera Contrato é uma ferramenta tecnológica de automação de documentos e não presta assessoria jurídica. 
