        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8 text-center md:text-left">
           ...
           <div>
             ...
             <ul className="text-sm space-y-2">
               <li><button onClick={() => onNavigate('servico')} className="hover:text-blue-400 transition-colors">Prestação de Serviços</button></li>
               <li><button onClick={() => onNavigate('residencial')} className="hover:text-blue-400 transition-colors">Aluguel Residencial</button></li>
               <li><button onClick={() => onNavigate('comercial')} className="hover:text-blue-400 transition-colors">Aluguel Comercial</button></li>
               <li><button onClick={() => onNavigate('veiculo')} className="hover:text-blue-400 transition-colors">Compra e Venda de Veículo</button></li>
             </ul>
           </div>
           ...
           <div>
             ...
             <ul className="text-sm space-y-2">
               <li><button onClick={() => onNavigate('about')} className="hover:text-blue-400 transition-colors">Quem Somos</button></li>
               <li><button onClick={() => onNavigate('faq')} className="hover:text-blue-400 transition-colors">Perguntas Frequentes (FAQ)</button></li>
               ...
               <li><button onClick={() => onNavigate('cookies')} className="hover:text-blue-400 transition-colors">Política de Cookies</button></li>
             </ul>
           </div>
